      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-2xl font-black text-[#111111] tracking-tight">로그인</h1>
            <p className="text-sm text-[#888888] mt-1">스트레이트랩 CRM 관리자 전용</p>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-[#AAAAAA]">
            계정이 없으신가요?{' '}
            <Link href="/signup" prefetch={false} className="text-[#111111] font-bold underline underline-offset-2">
              회원가입
            </Link>
          </p>
        </div>
