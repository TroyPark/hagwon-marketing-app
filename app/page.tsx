    ...
    <main className="min-h-screen bg-white font-sans">
      ...
      <section className="px-6 pt-24 pb-28 bg-white border-b border-black/10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-10">
            <div className="h-px w-10 bg-[#96051D]" />
            <span className="text-xs font-bold text-[#96051D] uppercase tracking-[0.2em]">학원 마케팅 전문 기업</span>
          </div>
          ...
          <div className="flex items-start gap-px mb-10">
            <div className="w-1 h-16 bg-[#96051D]" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start">
            <Link
              href="/survey"
              prefetch={false}
              className="inline-flex items-center gap-3 bg-[#96051D] hover:bg-[#6B0414] text-white font-bold text-sm px-8 py-4 transition-colors tracking-widest uppercase"
            >
              무료 진단 받기
      ...
      <section className="px-6 py-24 bg-white border-b border-black/10">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-14">
            <div className="h-px w-10 bg-[#96051D]" />
            <span className="text-xs font-bold text-[#96051D] uppercase tracking-[0.2em]">서비스 특징</span>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-0 border border-black/10">
            {[
              ...
              <div key={i} className={`p-8 ${i < 2 ? 'border-r border-black/10' : ''}`}>
                <div className="w-8 h-8 bg-[#96051D] text-white flex items-center justify-center mb-6">
                  {item.icon}
                </div>
      ...
      <section className="px-6 py-24 bg-[#F5F5F5] border-b border-black/10">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-14">
            <div className="h-px w-10 bg-[#96051D]" />
            <span className="text-xs font-bold text-[#96051D] uppercase tracking-[0.2em]">진단 프로세스</span>
          </div>
          <h2 className="text-4xl font-black text-[#111111] mb-14 leading-tight">
            3단계로 완성되는<br />마케팅 전략
          </h2>
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <div key={i} className="relative">
                ...
                <div className="h-px w-12 bg-[#96051D] mb-4" />
      ...
      <section className="px-6 py-24 bg-white border-b border-black/10">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-14">
            <div className="h-px w-10 bg-[#96051D]" />
            <span className="text-xs font-bold text-[#96051D] uppercase tracking-[0.2em]">고객 후기</span>
          </div>
          <h2 className="text-4xl font-black text-[#111111] mb-14 leading-tight">
            실제 원장님의 경험
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-0 divide-x divide-black/10">
            {[
              ...
              <div key={i} className="flex gap-4 px-8 py-6">
                <div className="w-8 h-8 bg-[#96051D] text-white flex items-center justify-center flex-shrink-0">
                  {item.icon}
                </div>
                <div>
