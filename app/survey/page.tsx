    ...
    <div className="bg-white border-b border-black/10 px-6 py-4 no-print">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="h-0.5 bg-[#E5E5E5] overflow-hidden">
          <div className="h-full bg-[#96051D] transition-all duration-500" style={{ width: `${pct}%` }} />
        </div>
      </div>
    </div>
  );
            ...
            return (
              <button
                ...
                className={`text-left px-4 py-3 border transition-all text-sm min-h-[48px] flex items-center gap-3 ${
                  isSelected
                    ? 'border-[#96051D] bg-[#96051D] text-white'
                    : 'border-[#E5E5E5] bg-white text-[#444444] hover:border-[#96051D]/40 hover:bg-[#FDF2F4]'
                }`}
              >
    ...
    <form onSubmit={handleSubmit} className="animate-fade-in-up">
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          <div className="h-px w-6 bg-[#96051D]" />
      ...
      <div className="flex justify-between items-center mt-8 pb-10">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#96051D] hover:bg-[#6B0414] disabled:opacity-40 text-white font-bold px-7 py-3 transition-all text-sm uppercase tracking-widest"
        >
          {submitting ? (
          ...
          {showContactStep ? (
            ...
            <>
              ...
              <div className="flex justify-between items-center mt-8 pb-10">
                ...
                <button
                  onClick={handleNext}
                  className="flex items-center gap-2 bg-[#96051D] hover:bg-[#6B0414] text-white font-bold px-7 py-3 transition-all text-sm uppercase tracking-widest"
                >
